...
store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_8__src_actions__["r" /* fetchAssets */])());
...
/* harmony export (immutable) */ __webpack_exports__["b"] = CLEAR_ERRORS;

const FETCH_ASSETS_SUCCESS = 'FETCH_ASSETS_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["e"] = FETCH_ASSETS_SUCCESS;

const FETCH_ASSETS_FAILURE = 'FETCH_ASSETS_FAILURE';
/* harmony export (immutable) */ __webpack_exports__["d"] = FETCH_ASSETS_FAILURE;

const FETCH_ASSETS = 'FETCH_ASSETS';
/* harmony export (immutable) */ __webpack_exports__["c"] = FETCH_ASSETS;

const CHANGE_TRANSACTION_HISTORY_FILTERS = 'CHANGE_TRANSACTION_HISTORY_FILTERS';
/* harmony export (immutable) */ __webpack_exports__["a"] = CHANGE_TRANSACTION_HISTORY_FILTERS;

const FETCH_MYBIT_PRICE_USD = 'FETCH_MYBIT_PRICE_USD';
/* harmony export (immutable) */ __webpack_exports__["i"] = FETCH_MYBIT_PRICE_USD;

const FETCH_MYBIT_PRICE_USD_SUCCESS = 'FETCH_MYBIT_PRICE_USD_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["k"] = FETCH_MYBIT_PRICE_USD_SUCCESS;

const FETCH_MYBIT_PRICE_USD_FAILURE = 'FETCH_MYBIT_PRICE_USD_FAILURE';
/* harmony export (immutable) */ __webpack_exports__["j"] = FETCH_MYBIT_PRICE_USD_FAILURE;

const FETCH_ETHEREUM_PRICE_USD = 'FETCH_ETHEREUM_PRICE_USD';
/* harmony export (immutable) */ __webpack_exports__["f"] = FETCH_ETHEREUM_PRICE_USD;

const FETCH_ETHEREUM_PRICE_USD_SUCCESS = 'FETCH_ETHEREUM_PRICE_USD_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["h"] = FETCH_ETHEREUM_PRICE_USD_SUCCESS;

const FETCH_ETHEREUM_PRICE_USD_FAILURE = 'FETCH_ETHEREUM_PRICE_USD_FAILURE';
/* harmony export (immutable) */ __webpack_exports__["g"] = FETCH_ETHEREUM_PRICE_USD_FAILURE;

const LOAD_METAMASK_USER_DETAILS = 'LOAD_METAMASK_USER_DETAILS';
/* harmony export (immutable) */ __webpack_exports__["o"] = LOAD_METAMASK_USER_DETAILS;

const LOAD_METAMASK_USER_DETAILS_SUCCESS = 'LOAD_METAMASK_USER_DETAILS_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["q"] = LOAD_METAMASK_USER_DETAILS_SUCCESS;

const LOAD_METAMASK_USER_DETAILS_FAILURE = 'LOAD_METAMASK_USER_DETAILS_FAILURE';
/* harmony export (immutable) */ __webpack_exports__["p"] = LOAD_METAMASK_USER_DETAILS_FAILURE;

const FETCH_TRANSACTION_HISTORY = 'FETCH_TRANSACTION_HISTORY';
/* harmony export (immutable) */ __webpack_exports__["l"] = FETCH_TRANSACTION_HISTORY;

const FETCH_TRANSACTION_HISTORY_SUCCESS = 'FETCH_TRANSACTION_HISTORY_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["n"] = FETCH_TRANSACTION_HISTORY_SUCCESS;

const FETCH_TRANSACTION_HISTORY_FAILURE = 'FETCH_TRANSACTION_HISTORY_FAILURE';
/* harmony export (immutable) */ __webpack_exports__["m"] = FETCH_TRANSACTION_HISTORY_FAILURE;
...
/* unused harmony export fetchAssetsSuccess */
...
/* unused harmony export fetchAssetsFailure */
...
/* unused harmony export fetchMyBitPriceUSDSuccess */
...
/* unused harmony export fetchMyBitPriceUSDFailure */
...
/* unused harmony export fetchEthereumPriceUSDSuccess */
...
/* unused harmony export fetchEthereumPriceUSDFailure */
...
/* unused harmony export setTransactionHistoryFilters */
...
/* unused harmony export loadMetamaskUserDetailsSuccess */
...
/* unused harmony export loadMetamaskUserDetailsFailure */
...
/* unused harmony export fetchTransactionHistorySuccess */
...
/* unused harmony export fetchTransactionHistoryFailure */
...
/* unused harmony export fetchTransactionHistory */
...
/* unused harmony export loadMetamaskUserDetails */

const fetchPriceFromCoinmarketcap = ticker => async dispatch => {
  switch (ticker) {
    case __WEBPACK_IMPORTED_MODULE_4__constants__["d" /* MYBIT_TICKER_COINMARKETCAP */]:
      dispatch({
...
/* unused harmony export fetchPriceFromCoinmarketcap */
...
const fetchAssets = () => async (dispatch, getState) => {
  ...
  try {
    ...
    const assets = Object(__WEBPACK_IMPORTED_MODULE_5__util_helpers__["b" /* mergeAllLogsByAssetId */])(combinedLogs);
...
/* harmony export (immutable) */ __webpack_exports__["r"] = fetchAssets;
...
/* unused harmony export USD_MYB_SYMBOL */
...
/* harmony export (immutable) */ __webpack_exports__["d"] = MYBIT_TICKER_COINMARKETCAP;
...
const assets = (state = initialState, action) => {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__actions__["e" /* FETCH_ASSETS_SUCCESS */]:
...
const errors = (state = initialState, action) => {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__actions__["d" /* FETCH_ASSETS_FAILURE */]:
      return [...state, action.payload.error];

    case __WEBPACK_IMPORTED_MODULE_0__actions__["b" /* CLEAR_ERRORS */]:
      return initialState;
...
const loading = (state = initialState, action) => {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__actions__["f" /* FETCH_ETHEREUM_PRICE_USD */]:
    case __WEBPACK_IMPORTED_MODULE_0__actions__["i" /* FETCH_MYBIT_PRICE_USD */]:
      return _objectSpread({}, state, {
        prices: true
      });

    case __WEBPACK_IMPORTED_MODULE_0__actions__["h" /* FETCH_ETHEREUM_PRICE_USD_SUCCESS */]:
    case __WEBPACK_IMPORTED_MODULE_0__actions__["g" /* FETCH_ETHEREUM_PRICE_USD_FAILURE */]:
    case __WEBPACK_IMPORTED_MODULE_0__actions__["k" /* FETCH_MYBIT_PRICE_USD_SUCCESS */]:
    case __WEBPACK_IMPORTED_MODULE_0__actions__["j" /* FETCH_MYBIT_PRICE_USD_FAILURE */]:
      return _objectSpread({}, state, {
        prices: false
      });

    case __WEBPACK_IMPORTED_MODULE_0__actions__["c" /* FETCH_ASSETS */]:
      return _objectSpread({}, state, {
        assets: true
      });
    ...
    case __WEBPACK_IMPORTED_MODULE_0__actions__["o" /* LOAD_METAMASK_USER_DETAILS */]:
      return _objectSpread({}, state, {
        user: true
      });

    case __WEBPACK_IMPORTED_MODULE_0__actions__["q" /* LOAD_METAMASK_USER_DETAILS_SUCCESS */]:
    case __WEBPACK_IMPORTED_MODULE_0__actions__["p" /* LOAD_METAMASK_USER_DETAILS_FAILURE */]:
      return _objectSpread({}, state, {
        user: false
      });

    case __WEBPACK_IMPORTED_MODULE_0__actions__["l" /* FETCH_TRANSACTION_HISTORY */]:
      return _objectSpread({}, state, {
        transactionHistory: true
      });

    case __WEBPACK_IMPORTED_MODULE_0__actions__["n" /* FETCH_TRANSACTION_HISTORY_SUCCESS */]:
    case __WEBPACK_IMPORTED_MODULE_0__actions__["m" /* FETCH_TRANSACTION_HISTORY_FAILURE */]:
      return _objectSpread({}, state, {
...
const transactions = (state = initialState, action) => {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__actions__["a" /* CHANGE_TRANSACTION_HISTORY_FILTERS */]:
...
/* harmony export (immutable) */ __webpack_exports__["b"] = mergeAllLogsByAssetId;
...
/* unused harmony export getPrettyCategoryName */
...
/* unused harmony export getImageForCategory */
...
const getWeb3Async = () => {
  ...
  if (window.web3) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__constants__["e" /* debug */])('Metamask Loaded');
  } else {
...
//# sourceMappingURL=0.d2b6580a3902ad340b5b.hot-update.js.map